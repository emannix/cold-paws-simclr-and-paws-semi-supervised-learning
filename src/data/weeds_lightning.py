...
def DeepweedsDatasetModule(batch_size=100, labelled_samples=100, unlabelled_samples=1000, 
    ...
    train_csv_file = 'deepweeds-train.csv'
    train_folder = 'images'
    test_csv_file = 'deepweeds-test.csv'

    if 'PBS_JOBFS' in os.environ and os.environ['PBS_JOBFS'] != "":
        base_data_path = os.environ['PBS_JOBFS']
        base_data_path = base_data_path+'/deepweeds/'
    else:
        try:
            base_data_path = '../../data/deepweeds/'
    ...
    train = ImageFolderCSVDataset(image_folder=data_path+train_folder, 
        transform=transform_training, return_index = return_index,
        metadata_csv_file=data_path+train_csv_file, 
        metadata_csv_image = 'Filename', 
        metadata_csv_label = 'Species', image_ext = '',
        )
    ...
    test = ImageFolderCSVDataset(image_folder=data_path+train_folder, 
